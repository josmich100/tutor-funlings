        ...
        <SimpleBar style={{ height: "900px" }}>
          <div data-simplebar className="h-100">
            ...
            <div className="p-4">
              ...
              <div className="mb-2">
                <Link
                  to="//Funlings Entertainment-v-light.react.themesbrand.com"
                  target="_blank"
                >
                  <img
                    src={layout1}
              ...
              <div className="mb-2">
                <Link
                  to="//Funlings Entertainment-v-dark.react.themesbrand.com"
                  target="_blank"
                >
                  <img
                    src={layout2}
              ...
              <div className="mb-2">
                <Link
                  to="//Funlings Entertainment-v-rtl.react.themesbrand.com"
                  target="_blank"
                >
                  <img
                    src={layout3}
              ...
              <Link
                to="//1.envato.market/Funlings Entertainmentreact"
