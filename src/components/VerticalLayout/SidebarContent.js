          ...
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              <Link to="/lessons">
                ...
                <span>{props.t("My Lessons")}</span>
              </Link>
            </li>
            <li>
              <Link to="/projects">
                <i className="bx bx-box"></i>
                <span>{props.t("My Projects")}</span>
              </Link>
            </li>
            <li>
              <Link to="/quizzes">
                <i className="bx bx-question-mark"></i>
                <span>{props.t("My Quizzes")}</span>
              </Link>
            </li>
            <li>
              <Link to="/certificates">
                <i className="bx bx-file"></i>
                <span>{props.t("My Certificates")}</span>
              </Link>
            </li>
            <li>
              <Link to="/invite">
                <i className="bx bx-user-plus"></i>
                <span>{props.t("Invite Friends")}</span>
              </Link>
            </li>
            <li>
              <Link to="/competitions">
                <i className="bx bx-trophy"></i>
                <span>{props.t("Competitions")}</span>
              </Link>
            </li>
            {/* <li>
