const invoiceList = [
  {
    ...
    founderAt: "Funlings Entertainment",
    invoiceID: "14251",
    company: "Funlings Entertainment Dashboard UI",
    invoicePrice: "1455",
    date: "10 Oct, 19",
    color: "primary",
    orderId: "12345",
    ...
    orderSummary: {
      items: [
        {
          id: 1,
          item: "Funlings Entertainment - Admin Dashboard Template",
          price: "$499.00",
        },
        {
          id: 2,
          item: "Funlings Entertainment - Landing Template",
          price: "$399.00",
        },
        {
          id: 3,
  ...
  },
  {
    ...
    orderSummary: {
      items: [
        {
          id: 1,
          item: "Funlings Entertainment - Bootstrap 4 Admin Dashboard",
          price: "$499.00",
        },
        {
          id: 2,
          item: "Funlings Entertainment - Bootstrap 4 Landing Template",
          price: "$399.00",
        },
        {
          id: 3,
